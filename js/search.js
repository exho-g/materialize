(function ($) {
    $(document).ready(function () {
        ...
        window.indexStore = [{
            ...
            tags: 'alerts components',
            body: 'Alerts are great for getting attention in a page as it provides contextual feedback messages for typical user actions.'
        }, {
            href: 'badges.html',
            ...
            tags: 'tree view components heirarchy',
            body: 'Tree viewing is a way of displaying heirarchy.'
        }, {
            href: 'color.html',
            title: 'CSS > Color',
            tags: 'color css',
            ...
            href: 'helpers.html',
            title: 'CSS > Helpers',
            tags: 'helper css align float hide show format formatting scrollbar beautify-scrollbar',
            body: 'helper classes'
        }, {
            href: 'media-css.html',
            title: 'CSS > Media',
            ...
            body: 'Dark Mode displays dark surfaces across the majority of the UI.'
        }, {
            href: 'pulse.html',
            title: 'CSS > Pulse',
            tags: 'pulse css',
            ...
            href: 'stepper.html',
            title: 'JavaScript > Stepper',
            tags: 'stepper javascript js mstepper',
            body: 'Stepper divides a huge form to sections to not overwhelm a viewer.'
        }, {
            href: 'tabs.html',
